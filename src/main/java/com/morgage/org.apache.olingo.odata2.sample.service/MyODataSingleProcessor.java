...
import static com.morgage.org.apache.olingo.odata2.sample.service.MyEdmProvider.ENTITY_SET_NAME_CARS;
import static com.morgage.org.apache.olingo.odata2.sample.service.MyEdmProvider.ENTITY_SET_NAME_ACCOUNT;
...
public class MyODataSingleProcessor extends ODataSingleProcessor {
    ...
    public ODataResponse readEntity(GetEntityUriInfo uriInfo, String contentType) throws ODataException {
        ...
        if (uriInfo.getNavigationSegments().size() == 0) {
            ...
            } else if (ENTITY_SET_NAME_ACCOUNT.equals(entitySet.getName())) {
                int id = getKeyValue(uriInfo.getKeyPredicates().get(0));
            ...
            if (ENTITY_SET_NAME_ACCOUNT.equals(entitySet.getName())) {
