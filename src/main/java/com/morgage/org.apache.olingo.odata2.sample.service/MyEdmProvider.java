package com.morgage.org.apache.olingo.odata2.sample.service;
...
public class MyEdmProvider extends EdmProvider {
    static final String ENTITY_SET_NAME_ACCOUNT = "Account";
    ...
    public List<Schema> getSchemas() throws ODataException {
        ...
        entitySets.add(getEntitySet(ENTITY_CONTAINER, ENTITY_SET_NAME_ACCOUNT));
        entityContainer.setEntitySets(entitySets);

        List<AssociationSet> associationSets = new ArrayList<AssociationSet>();
        associationSets.add(getAssociationSet(ENTITY_CONTAINER, ASSOCIATION_CAR_MANUFACTURER, ENTITY_SET_NAME_ACCOUNT, ROLE_1_2));
    ...
    public EntitySet getEntitySet(String entityContainer, String name) throws ODataException {
        if (ENTITY_CONTAINER.equals(entityContainer)) {
            ...
            } else if (ENTITY_SET_NAME_ACCOUNT.equals(name)) {
        ...
        if (ENTITY_CONTAINER.equals(entityContainer)) {
            if (ASSOCIATION_CAR_MANUFACTURER.equals(association)) {
                return new AssociationSet().setName(ASSOCIATION_SET)
                        ...
                        .setEnd1(new AssociationSetEnd().setRole(ROLE_1_2).setEntitySet(ENTITY_SET_NAME_ACCOUNT))
